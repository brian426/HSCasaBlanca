...
import ComponenteAdministracion.BDUsuario;
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(botonIngresar, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(69, 69, 69))
        );
    ...
    private void botonIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIngresarActionPerformed
        ...
        try {
            if (usuario.isEmpty() || clave.isEmpty()) {
                ImageIcon img = new ImageIcon(getClass().getResource("/ComponenteImagenes/alert.png"));
                JOptionPane.showMessageDialog(null, "Los campos usuario y password no deben estar vacíos", "Alerta", JOptionPane.DEFAULT_OPTION,img);
            } else {
               Usuario u = BDUsuario.login(usuario, clave);
                if (u!=null) {
                    if (u.getEstado()==1) {
                         FrmMenuPrincipal frmMP = new FrmMenuPrincipal();
                    frmMP.lblNombreVendedor.setText(u.getNombre());
                    frmMP.lblApellidos.setText(u.getApellidos());
                    frmMP.lblDni.setText(u.getDni());
                    frmMP.lblCelular.setText(u.getCelular());
                    frmMP.lblCorreo.setText(u.getCorreo());
                    frmMP.lblCodigoUser.setText(u.getIdUsuario()+"");
                    frmMP.setVisible(true);
                    this.dispose();
                    } else {
                        ImageIcon img = new ImageIcon(getClass().getResource("/ComponenteImagenes/alert.png"));
                    JOptionPane.showMessageDialog(null, "Lo sentimos, su cuenta no está habilitada. Consulte con el administrador(a)", "Alerta", JOptionPane.DEFAULT_OPTION,img);
                    }
                   
                } else {
                     ImageIcon img = new ImageIcon(getClass().getResource("/ComponenteImagenes/alert.png"));
                    JOptionPane.showMessageDialog(null, "El usuario o contraseña es incorrecto", "Alerta", JOptionPane.DEFAULT_OPTION,img);
                }
            }
