 ...
 * @author BADY RICHARD
 */
public class FrmConsultaReservacion extends javax.swing.JFrame {

    /** Creates new form FrmConsultaProducto */
    public FrmConsultaReservacion() {
        try {
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaReservacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmConsultaReservacion().setVisible(true);
            }
        });
    }
