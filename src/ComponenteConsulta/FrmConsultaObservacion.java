 ...
 * @author BADY RICHARD
 */
public class FrmConsultaObservacion extends javax.swing.JFrame {

    /** Creates new form FrmConsultaProducto */
    public FrmConsultaObservacion() {
        try {
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaObservacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmConsultaObservacion().setVisible(true);
            }
        });
    }
